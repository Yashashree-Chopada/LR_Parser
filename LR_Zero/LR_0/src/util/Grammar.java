...
public class Grammar {
    ...
    private HashMap<String, HashSet<String>> firstSets = new HashMap<String,HashSet<String>>();
    private HashMap<String, HashSet<String>> fallowSets = new HashMap<String,HashSet<String>>();
    ...
    public HashSet<Rule> getRuledByLeftVariable(String variable) {
        HashSet<Rule> variableRules = new HashSet<Rule>();
        for (Rule rule : rules) {
            if (rule.getLeftSide().equals(variable)) {
