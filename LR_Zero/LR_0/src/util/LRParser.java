...
public abstract class LRParser {
    ...
    protected static HashMap<String, Integer>[] goToTable;
    protected static HashMap<String, Action>[] actionTable;
    ...
    public static boolean accept(ArrayList<String> inputs) {
    ...
    public gotoc goToTableStr() {
        ...
        for (int i = 0; i < goToTable.length; i++) {
            ...
            for (String variable : grammar.getVariables()) {
                ...
                nl.add(goToTable[i].get(variable));
            }
            g.setAl(nl);
            str += "\n";
        ...
        g.setSt(goToTable.length);
        System.out.println("Len - "+goToTable.length);
        System.out.println("str - "+str);
        System.out.println("arr list - "+g.getAl());
        return g;
    }

    public Actiontable actionTableStr() {
    	Action a = new Action();
    	Actiontable aa = new Actiontable();
    	ArrayList<Action> na = new ArrayList<Action>();
    	ArrayList<String> nt = new ArrayList<String>();
        String str = "Action Table : \n";
        HashSet<String> terminals = new HashSet<String>(grammar.getTerminals());
        terminals.add("$");
        str += "                ";
        ...
        for (int i = 0; i < actionTable.length; i++) {
            ...
            for (String terminal : terminals) {
               ...
               na.add(actionTable[i].get(terminal));
            }
            aa.setTa(na);
            str += "\n";
        }
        ...
        aa.setAt(actionTable.length);
        System.out.println("Actiontable len -"+actionTable.length);
        return aa;
    }
